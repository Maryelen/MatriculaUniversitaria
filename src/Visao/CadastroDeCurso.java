				...
				.addGroup(gl_panel.createSequentialGroup()
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel.createSequentialGroup().addGap(19)
										.addGroup(gl_panel
												.createParallelGroup(Alignment.LEADING).addComponent(lblNome)
												.addComponent(lblUnidade).addComponent(lblVincularDisciplina)))
								.addGroup(
										gl_panel.createSequentialGroup()
												.addContainerGap().addComponent(btnVoltar)))
						...
						.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING, false)
								.addGroup(gl_panel.createSequentialGroup()
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
												...
												.addComponent(scrollPaneDisciplinasCurso, GroupLayout.DEFAULT_SIZE,
														177, Short.MAX_VALUE)
										...
										.addGap(302))
								.addGroup(gl_panel.createSequentialGroup().addComponent(button_1).addGap(168)))));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addComponent(lblCadastroDeCurso).addGap(29)
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGap(7)
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel.createSequentialGroup().addGap(5).addComponent(lblUnidade))
								.addGroup(gl_panel.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED)
										...
										.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
												.addComponent(scrollPaneDisciplinasCurso, GroupLayout.PREFERRED_SIZE,
														135, GroupLayout.PREFERRED_SIZE)
												.addComponent(lblVincularDisciplina))))
						.addPreferredGap(ComponentPlacement.RELATED, 18, Short.MAX_VALUE).addGroup(gl_panel
								.createParallelGroup(Alignment.BASELINE).addComponent(btnVoltar).addComponent(button_1))
						.addContainerGap()));
