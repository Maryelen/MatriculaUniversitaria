...
public class EditarCurso extends JFrame {
	...
	public EditarCurso(Curso curso) {
		...
		curso.setListaDisciplinasCurso(
				new ArrayList<Disciplina>(ControleDeCurso.pegarDisciplinasPeloCurso(curso.getIdCurso())));
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				cursoAtualizado = controleDeCurso.atualizarCurso(curso, listaDisciplinasPerderamSelecao,
						((Unidade) cmbIdUnidade.getSelectedItem()).getIdUnidade(), txtNome.getText());
