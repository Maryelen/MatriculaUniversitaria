...
public class Relatorio extends JFrame {
	...
	public Relatorio() {
		...
		gl_pnlSistemaMatriUniversitario.setHorizontalGroup(gl_pnlSistemaMatriUniversitario
				...
				.addGroup(gl_pnlSistemaMatriUniversitario.createSequentialGroup().addContainerGap(149, Short.MAX_VALUE)
						.addComponent(lblRelatoriosDoSistema).addGap(140))
				.addComponent(btnDisciplinasLecionadas, GroupLayout.DEFAULT_SIZE, 426, Short.MAX_VALUE));
		gl_pnlSistemaMatriUniversitario.setVerticalGroup(gl_pnlSistemaMatriUniversitario
				.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlSistemaMatriUniversitario.createSequentialGroup().addContainerGap()
						.addComponent(lblRelatoriosDoSistema).addGap(18).addComponent(btnMatriculadosDisciplina)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnDisciplinasMatriculadasPorAluno)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnDisciplinasLecionadas)
